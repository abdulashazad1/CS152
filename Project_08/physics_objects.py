...
#moving on to defining a child class 'Block' with 'Thing' as the parent class
...
class Car(Thing):
    ...
    def __init__(self, win, w1=2.3,h1=1.1,w2=1.4,h2=1,r=0.3,c=None):
        Thing.__init__(self, win, 'ball')
        self.h1=h1
        self.h2=h2
        self.w1=w1
